...
class GeolocationService {
    ...
    constructor(provider, config = {}) {
        ...
        this.throttledWatchHandler = (0, throttle_1.throttle)(this._rawWatchHandler, this._throttleInterval);
        this.config = {
    ...
    setThrottleInterval(ms) {
        ...
        this.throttledWatchHandler = (0, throttle_1.throttle)(this._rawWatchHandler, ms);
    }
}

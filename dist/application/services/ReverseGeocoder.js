...
exports.ReverseGeocoder = void 0;
const ObserverSubject_1 = require("../ObserverSubject");
const withObserver_1 = require("../../utils/withObserver");
const reverseGeocoderEvents_1 = require("./reverseGeocoderEvents");
const defaultLogger = {
...
class ReverseGeocoder {
    ...
    constructor(options) {
        ...
        this._positionUpdateEvent =
            options.positionUpdateEvent ?? reverseGeocoderEvents_1.POSITION_UPDATE_EVENT;
        this._immediateAddressUpdateEvent =
            options.immediateAddressUpdateEvent ?? reverseGeocoderEvents_1.IMMEDIATE_ADDRESS_UPDATE_EVENT;
        ...
        this.observerSubject = new ObserverSubject_1.ObserverSubject();
    }
    _subscribe(url) {
    ...
    async completeWithAddress(geoAddress, provider) {
        ...
        this.notifyObservers(this.currentAddress, this.standardizedAddress, reverseGeocoderEvents_1.ADDRESS_FETCHED_EVENT, false, null);
        return geoAddress;
    }
    ...
    handleFetchError(err) {
        ...
        this.error = err;
        this.notifyObservers(null, null, reverseGeocoderEvents_1.GEOCODING_ERROR_EVENT, false, err);
    }
...
Object.assign(ReverseGeocoder.prototype, (0, withObserver_1.withObserver)({ excludeNotify: true }));
exports.default = ReverseGeocoder;

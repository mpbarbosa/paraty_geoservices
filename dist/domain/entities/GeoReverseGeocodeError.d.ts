 ...
 */
export declare function createGeoReverseGeocodeError(code: GeoReverseGeocodeError['code'], message: string): Error & GeoReverseGeocodeError;
//# sourceMappingURL=GeoReverseGeocodeError.d.ts.map
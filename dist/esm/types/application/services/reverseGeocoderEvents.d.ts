...
export declare const ADDRESS_FETCHED_EVENT = "Address fetched";
/** Emitted when reverse geocoding fails. */
export declare const GEOCODING_ERROR_EVENT = "Geocoding error";
/** PositionManager event: coordinates were accepted and updated. */
export declare const POSITION_UPDATE_EVENT = "PositionManager updated";
/** PositionManager event: immediate address refresh without full position gate. */
export declare const IMMEDIATE_ADDRESS_UPDATE_EVENT = "Immediate address update";

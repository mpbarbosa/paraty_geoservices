...
exports.toGeoAddress = toGeoAddress;
 ...
 */
function parseLabel(label, addressNumber, municipality) {
 ...
 */
function toGeoAddress(rawData) {
    const address = rawData.address ?? {};
    const { street, neighborhood: labelNeighborhood } = parseLabel(address.label, address.addressNumber, address.municipality);
    return {
        street,
        streetNumber: address.addressNumber ?? null,
        complement: null,
        neighborhood: typeof address.neighborhood === 'string'
            ? address.neighborhood
            : labelNeighborhood,
        city: typeof address.municipality === 'string' ? address.municipality : null,
...
//# sourceMappingURL=AwsAddressMapper.js.map
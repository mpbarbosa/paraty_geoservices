...
exports.buildNominatimReverseUrl = buildNominatimReverseUrl;
exports.toGeoAddressFromNominatim = toGeoAddressFromNominatim;
const BRAZIL_CODES = new Set(['br', 'bra', 'brasil', 'brazil']);
/**
 * Builds a Nominatim reverse-geocode request URL.
 */
function buildNominatimReverseUrl(latitude, longitude, baseUrl, corsProxy = null) {
 ...
 */
function toGeoAddressFromNominatim(raw) {
...
//# sourceMappingURL=NominatimAddressMapper.js.map